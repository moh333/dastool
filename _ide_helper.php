...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function calculate($date, $time, $duration, $state)
        {
                        /** @var \App\Services\SurchargeService $instance */
                        return $instance->calculate($date, $time, $duration, $state);
        }
                    /**
         * 
         *
         * @param \Carbon\CarbonInterface[] $dates
         * @return array 
         * @static 
         */ 
        public static function calculateNight($dates)
        {
                        /** @var \App\Services\SurchargeService $instance */
                        return $instance->calculateNight($dates);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function hasNight($start, $end)
        {
                        /** @var \App\Services\SurchargeService $instance */
                        return $instance->hasNight($start, $end);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function calculateHoliday($dates, $state)
        {
                        /** @var \App\Services\SurchargeService $instance */
                        return $instance->calculateHoliday($dates, $state);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function hasHoliday($start, $end, $state)
        {
                        /** @var \App\Services\SurchargeService $instance */
                        return $instance->hasHoliday($start, $end, $state);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function calculate($type, $runCode, $pickCode, $dropCode, $cityId, $customerId, $vehicleId, $date, $time, $roundNet, $roundGross, $custom)
        {
                        return \App\Services\CalcerService::calculate($type, $runCode, $pickCode, $dropCode, $cityId, $customerId, $vehicleId, $date, $time, $roundNet, $roundGross, $custom);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function isHoliday($date, $state)
        {
                        return \App\Services\HolidayService::isHoliday($date, $state);
        }
...
namespace  { 
            ...
            class Surcharge extends \App\Facades\SurchargeFacade {}
            class Calcer extends \App\Facades\CalcerFacade {}
            class Holiday extends \App\Facades\HolidayFacade {}
