...
class AssignmentController extends BaseController
{
    ...
    {
        $Assignments = Assignment::where('suspensed',0)->where('deleted',0)->get();
        return response(['message' => '','data' => $Assignments,'code' => '200']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data                    = $request->all();
        $upassignment            = Assignment::findorfail($id);
    ...
    {
        $delassignment = Assignment::where('id',$id)->delete();
        $emptydata     = new \stdClass();
